...
const CONFIG = {
  github: {
    username: 'diegoacosta236', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: { // ** TODO **
    github: {
      ...
      manual: {
        ...
        projects: ['diegoacosta236/linktree', 'diegoacosta236/hangman_project'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
